                    ...
                    <div class="col-lg-12 col-xl-12">
                        <div class="card shadow mb-4">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h6 class="text-primary font-weight-bold m-0">Analyse Record</h6>
                            ...
                            <table class="table table-borderless">
                                ...
                                ?>
                             <label><br>Year</label><select name="year" class="form-control" onChange="showbranch(this);">
                                        <option value="">-- Please Select --</option>
                                        <?php foreach ($results as $rs) { ?>
                                            <option value="<?php echo $rs["id"]; ?>"><?php echo $rs["year_name"]; ?></option>
                                        <?php } ?>
                                    </select>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <input type="submit" value="Analyse" name="b1" class="btn btn-primary"/>
                                        <input type="reset" value="Reset" name="b2" class="btn btn-danger float-right" /><br>
                                    </td>
                                </tr>
                            </table>
                        </div>
